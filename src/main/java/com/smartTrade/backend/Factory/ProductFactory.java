...
public class ProductFactory{
    ...
    int id_categoria, java.sql.Date fecha_publicacion, boolean validado, int huella_ecologica,int id_imagen,int stock,String etiqueta_inteligente, List<Object> args) {
        if (productType == null) {
            return null;
        }
        ...
        static class ProcesadosFactory extends ComidaFactory {
            ...
            public  Procesados getProduct(Producto p,
                ...
                return new Procesados(p.getNombre(), p.getDescripcion(),
                        p.getId_categoria(),  p.getFecha_publicacion(),
                        p.getValidado(), p.getHuella_ecologica(),p.getId_imagen(),p.getStock(),p.getEtiqueta_inteligente(), (String) args.get(0), (double) args.get(1));
            }
        }
     ...
     static class DeporteFactory extends ProductFactory {
        ...
        public  Deporte getProduct(Producto p,
            ...
            return new Deporte(p.getNombre(), p.getDescripcion(),
                        p.getId_categoria(), p.getFecha_publicacion(),
                        p.getValidado(), p.getHuella_ecologica(),p.getId_imagen(),p.getStock(),p.getEtiqueta_inteligente(),(String) args.get(0), (String) args.get(1), (String) args.get(2), (String) args.get(3));
        }
    }
     ...
     static class ModaFactory extends ProductFactory {
        ...
        public  Moda getProduct(Producto p,
            ...
            return new Moda(p.getNombre(), p.getDescripcion(),
                        p.getId_categoria(), p.getFecha_publicacion(),
                        p.getValidado(), p.getHuella_ecologica(),p.getId_imagen(), p.getStock(),p.getEtiqueta_inteligente(), (String) args.get(0), (String) args.get(1), (String) args.get(2), (String) args.get(3), (String) args.get(4));
        }
    }
