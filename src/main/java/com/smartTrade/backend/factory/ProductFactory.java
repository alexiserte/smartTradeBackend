...
public class ProductFactory{
    ...
    int id_categoria, String imagen, java.sql.Date fecha_publicacion, boolean validado, int huella_ecologica, List<Object> args) {
        ...
        Producto producto = new Producto(nombre, descripcion, id_categoria, imagen, fecha_publicacion, validado, huella_ecologica);
     ...
     static class HigieneFactory extends ProductFactory {
        ...
        public  Higiene getProduct(Producto producto, List<Object> args) {
            return new Higiene(producto.getNombre(), producto.getDescripcion(), producto.getId_categoria(), producto.getImagen(), producto.getFecha_publicacion(), producto.getValidado(), producto.getHuella_ecologica());
        }
    }
