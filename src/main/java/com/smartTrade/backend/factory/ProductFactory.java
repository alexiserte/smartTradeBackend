...
public class ProductFactory{
    ...
    int id_categoria, java.sql.Date fecha_publicacion, boolean validado, int huella_ecologica,int id_imagen,int stock, List<Object> args) {
        if (productType == null) {
            return null;
        }
        Producto producto = new Producto(nombre, descripcion, id_categoria, fecha_publicacion, validado, huella_ecologica,id_imagen,stock);
     ...
     static class HigieneFactory extends ProductFactory {
        ...
        public  Higiene getProduct(Producto producto, List<Object> args) {
            return new Higiene(producto.getNombre(), producto.getDescripcion(), producto.getId_categoria(), producto.getFecha_publicacion(), producto.getValidado(), producto.getHuella_ecologica(),producto.getId_imagen(), producto.getStock());
        }
    }
        ...
        public  Alimentacion getProduct(Product_Types type, Producto p, List<Object> args) {
            ...
            if (type == Product_Types.PROCESADOS || type == Product_Types.FRESCOS || type == Product_Types.COMIDA) {
                ...
                return new Alimentacion(p.getNombre(), p.getDescripcion(),
                        ...
                        p.getValidado(), p.getHuella_ecologica(), p.getId_imagen(),p.getStock());
            }
        ...
        static class ProcesadosFactory extends ComidaFactory {
            ...
            public  Procesados getProduct(Producto p,
                ...
                return new Procesados(p.getNombre(), p.getDescripcion(),
                        p.getId_categoria(),  p.getFecha_publicacion(),
                        p.getValidado(), p.getHuella_ecologica(),p.getId_imagen(),p.getStock(), (String) args.get(0), (double) args.get(1));
            }
        }
     ...
     static class DeporteFactory extends ProductFactory {
        ...
        public  Deporte getProduct(Producto p,
            ...
            return new Deporte(p.getNombre(), p.getDescripcion(),
                        p.getId_categoria(), p.getFecha_publicacion(),
                        p.getValidado(), p.getHuella_ecologica(),p.getId_imagen(),p.getStock(), (String) args.get(0), (String) args.get(1), (String) args.get(2), (String) args.get(3));
        }
    }
     ...
     static class ModaFactory extends ProductFactory {
        ...
        public  Moda getProduct(Producto p,
            ...
            return new Moda(p.getNombre(), p.getDescripcion(),
                        p.getId_categoria(), p.getFecha_publicacion(),
                        p.getValidado(), p.getHuella_ecologica(),p.getId_imagen(), p.getStock(), (String) args.get(0), (String) args.get(1), (String) args.get(2), (String) args.get(3), (String) args.get(4));
        }
    }
