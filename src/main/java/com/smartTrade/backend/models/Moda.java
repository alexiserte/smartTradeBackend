...
public class Moda extends Producto {
    ...
    public Moda(String nombre, String descripcion, int id_categoria, java.sql.Date fecha_publicacion, boolean validado, int huella_ecologica, String talla, String marca, String color, String tipoDePrenda, String seccion) {
