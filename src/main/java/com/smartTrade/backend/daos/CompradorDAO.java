...
public class CompradorDAO{
    ...
    public Comprador getCompradorByID(int id){
        return database.queryForObject("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE id_consumidor = ?",new CompradorMapper(),id);
    }

    public Comprador getCompradorByIDAndNombre(int id, String nombre){
        return database.queryForObject("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE nickname = ? AND id_consumidor = ?",new CompradorMapper(),nombre, id);
    }
    ...
    public List<Comprador> getCompradorByPuntosResponsabilidad(int puntos){
        return database.query("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE puntos_responsabilidad = ?",new CompradorMapper(),puntos);
    }

    public List<Comprador> getCompradorByPuntosResponsabilidadAndDireccion(int puntos, String direccion){
        return database.query("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE puntos_responsabilidad = ? AND direccion = ?",new CompradorMapper(),puntos, direccion);
    }

    public List<Comprador> getCompradorByPuntosResponsabilidadAndNombre(int puntos, String nombre){
        return database.query("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE puntos_responsabilidad = ? AND nickname = ?",new CompradorMapper(),puntos, nombre);
    }

    public List<Comprador> getCompradorByDireccionAndNombre(String direccion, String nombre){
        return database.query("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE direccion = ? AND nickname = ?",new CompradorMapper(),direccion, nombre);
    }

    public List<Comprador> getCompradorByDireccionAndNombreAndPuntosResponsabilidad(String direccion, String nombre, int puntos){
        return database.query("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE direccion = ? AND nickname = ? AND puntos_responsabilidad = ?",new CompradorMapper(),direccion, nombre, puntos);
    }

    public List<Comprador> getCompradorByDireccionAndPuntosResponsabilidad(String direccion, int puntos){
        return database.query("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE direccion = ? AND puntos_responsabilidad = ?",new CompradorMapper(),direccion, puntos);
    }

    public List<Comprador> getCompradorByNombreAndPuntosResponsabilidad(String nombre, int puntos){
        return database.query("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE nickname = ? AND puntos_responsabilidad = ?",new CompradorMapper(),nombre, puntos);
    }
    ...
    public List<Comprador> getCompradorByDireccionAndNombreAndPuntosResponsabilidadAndID(String direccion, String nombre, int puntos, int id){
        return database.query("SELECT id_consumidor,nickname,user_password,direccion,puntos_responsabilidad FROM consumidor WHERE direccion = ? AND nickname = ? AND puntos_responsabilidad = ? AND id_consumidor = ?",new CompradorMapper(),direccion, nombre, puntos, id);
    }
