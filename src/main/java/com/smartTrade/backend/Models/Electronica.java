...
public class Electronica extends Producto{
    ...
    public Electronica(String nombre, String descripcion, int id_categoria, java.sql.Date fecha_publicacion, boolean validado, int huella_ecologica,int id_imagen,int stock,String etiqueta_inteligente, String marca, String modelo, String tipo, String especificacionesTecnicas) {
